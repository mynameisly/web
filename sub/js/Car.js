...
function Car(color) {
  ...
  if (index>=0){
		  ...
		  function makeWindow(coords) {
			...
			var geometry = utils.makeExtrudeGeometry(shape, 0.01)
     ...
     loadModelcar_001() 
	 function loadModelcar_001() {
            loader = new THREE.GLTFLoader()
            loader.load('https://five-great.coding.me/car-lhl-001.glb', function (gltf) {
               var model = gltf.scene
                model.traverse(function (object) {
					...
					if(object.name=="node_id2811") {
						 that.wheels.push(object)
					     that.mesh.add(object)}
					if(object.name=="node_id2812") {
						 that.wheels.push(object)
					     that.mesh.add(object)}
					if(object.name=="node_id2813") {
						 that.wheels.push(object)
					     that.mesh.add(object)}
				    if(object.name=="node_id2814") {
						 that.wheels.push(object)
					     that.mesh.add(object)}
